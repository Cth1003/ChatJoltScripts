var songs = {
  ...
  wantYouGone: [
    ...
    /Now little [CK]aroline? is in here too/i,
    'One day they woke me up',
    /One day they woke me up/i,
    'So I could live forever',
    /So I could live forever/i,
    'It\'s such a shame the same will never happen to you',
    /It\'?s such a shame the same will never happen to you/i,
    'You\'ve got your short sad life left',
    /It\'?s such a shame the same/i,
    'Will never happen to you',
    /Will never happen to you/i,
    'You\'ve got your short sad life left',
    /You(?:\'?ve? got| have) your short\,? sad\,? life left/i,
    'That\'s what I\'m counting on',
    /That\'?s what I\'?m counting on/i,
    ...
    /Oh\,? did you think I meant? you/i,
    'That would be funny if it weren\'t so sad',
    /That would(?:\'?ve? been| be) funny if it w(?:ere|as)n\'?t so sad/i,
    ...
    /When I delete you maybe/i,
    'I\'ll stop feeling so bad',
    /I\'?ll? stop feeling so bad/i,
    'Go make some new disaster',
    /Go make some new disaster/i,
    'That\'s what I\'m counting on',
    /That\'?s what I\'?m counting on/i,
    'You\'re someone else\'s problem',
    /You(?:\'?re?| are) someone else\'?s? problem/i,
    /Now I only want you gone/i,
    'Now I only want you gone',
    /Now I only want you gone/i,
    'Now i only want you...',
