...
if (shouldRun) {
  ...
  var manualDefinitions = {
    ...
    'jelly': '1. Being jealous, or hating. 2. A GameJolt user. An animator tyro. Says \'Jello\' instead of \'Hello\'. Works on secret stuff and will trick you in believing that she is a bot but she really is just a Gumbly G Blockhead.',
    ...
    'nt games': 'A GameJolt user. Loves burritos as long as they are at least the size of his face, does a buttload of cool stuff with Game Maker and is a future train conductor. Has nothing to do with Windows NT.',
    'trinex' : 'A GameJolt user. A guy whose name sounds like medicine. Likes making games, faps for Valve and wishes to be a potted plant at their offices.',
    'trinexgames' : 'A GameJolt user. A guy whose name sounds like medicine. Likes making games, faps for Valve and wishes to be a potted plant at their offices.',
    'trinex games' : 'A GameJolt user. A guy whose name sounds like medicine. Likes making games, faps for Valve and wishes to be a potted plant at their offices.',
