...
var birthdays = {
  25584: {
    date: new Date(0, 3, 30),
    isOld: true
  }
};

var birthday = birthdays[user.id];
if (typeof birthday == 'object') {
  var today = new Date();
  var begin = new Date(today.getUTCFullYear(), birthday.date.getUTCMonth(), birthday.date.getUTCDate());
  var end = new Date(today.getUTCFullYear(), birthday.date.getUTCMonth(), birthday.date.getUTCDate() + 1);
  today = today.getTime();
